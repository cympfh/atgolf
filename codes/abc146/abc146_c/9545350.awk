# https://atcoder.jp/contests/abc146/submissions/9545350
BEGIN {
    E = 10000
}
...

{
    ...
    y = add(mul(int64(a), int64(1000000000)), mul(int64(b), int64(10)))
    if (!lt(x, y)) {
        print right
        exit
    }
    ...
    for (i=0; i<100; ++i) {
        ...
        y = add(mul(int64(a), int64(mid)), mul(int64(b), int64(keta(mid))))
        if (lt(x, y)) {
            right = mid;
        } else {
            left = mid;
